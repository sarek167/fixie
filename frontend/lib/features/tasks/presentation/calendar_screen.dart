                      ...
                      Padding(
                        ...
                        child: TableCalendar(
                          ...
                          headerStyle: HeaderStyle(
                            ...
                            titleCentered: true,
                            titleTextStyle: TextStyle(color: ColorConstants.whiteColor, fontSize: FontConstants.headerFontSize, fontWeight: FontWeight.bold),
                            leftChevronIcon: Icon(Icons.chevron_left, color: ColorConstants.whiteColor),
                            rightChevronIcon: Icon(Icons.chevron_right, color: ColorConstants.whiteColor),
                          ...
                          daysOfWeekStyle: DaysOfWeekStyle(
                            ...
                            weekdayStyle: TextStyle(color: Colors.white, fontSize: FontConstants.standardFontSize, fontWeight: FontWeight.bold),
                            weekendStyle: TextStyle(color: Colors.white, fontSize: FontConstants.standardFontSize, fontWeight: FontWeight.bold),
                          ),
                          calendarBuilders: CalendarBuilders(
                            defaultBuilder: (context, day, _) {
                              ...
                              return Container(
                                decoration: BoxDecoration(
                                  color: isCompleted ? ColorConstants.veryLightColor : Colors.grey.shade300,
